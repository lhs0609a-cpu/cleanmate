...
const GLYPHS = {
  ...
  6: [[...ring(0.5, 0.3, 0.34, 0.3, 18), [0.16, 0.44], [0.22, 0.76], [0.4, 0.96], [0.62, 1], [0.84, 0.9]].slice(0)],
  7: [[[0.13, 1], [0.88, 1], [0.42, 0]]],
  8: [ring(0.5, 0.75, 0.27, 0.25, 16), ring(0.5, 0.26, 0.33, 0.26, 18)],
  9: [[...ring(0.5, 0.7, 0.34, 0.3, 18), [0.84, 0.56], [0.78, 0.24], [0.6, 0.04], [0.38, 0], [0.16, 0.1]]],
  '.': [[[0.22, 0.02], [0.22, 0.03]]],
...
const WORDMARK = layoutText('CLEANMATE', 172, 120, 26, { tracking: 0.09 })
...
const SPEC = layoutText('WINDOWS 10 / 11 · 30 DAY UNDO · 100% ON DEVICE', 84, 556, 18, { tracking: 0.13 })
